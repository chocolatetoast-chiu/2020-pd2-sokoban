    ...
    ui(new Ui::LV1)
{
    ...
    connect(ui->nextlevel,SIGNAL(clicked()),this,SLOT(NextbuttonClick()));
}
...
void LV1::keyPressEvent(QKeyEvent *event)
{
    int x=ui->mario->x();
    int y=ui->mario->y();
    ...
    if(Succeed()){
        ui->nextlevel->setEnabled(true);
    }
}

bool LV1::CanPushLeft()
{
    int x=ui->mario->x();
    int y=ui->mario->y();
    int box1_x=ui->box1->x();
